...
NCareerProfile = {
	-- Mod defines
	MOD_STATISTICS_GROUP = "Ultra Historical Mod", -- Can be set by mods to collect statistics in a separate data set for the mod. Will also be used as the display name if MOD_STATISTICS_GROUP_NAME is not set.
	...
	ORCHESTRA_OF_BOOM_RIBBON_SPECIAL_BATTALION_COUNT = 8, -- Amount of special battalion types(anti-air, anti-tank, artillery and rocket artillery) required for the division for Orchestra of Boom Ribbon
	...
	ENGINEERING_BEHEMOTH_MEDAL_ARMOR_RATING_SILVER = 250, -- The armor rating required for the tanks to get the Engineering The Behemoth Silver Medal
	ENGINEERING_BEHEMOTH_MEDAL_ARMOR_RATING_GOLD = 315, -- The armor rating required for the tanks to get the Engineering The Behemoth Gold Medal
	CASTLES_IN_THE_AIR_MEDAL_AIR_DEFENSE_BRONZE = 25, -- The air defense required for the airplanes to get the Castles in the Air Bronze Medal
	CASTLES_IN_THE_AIR_MEDAL_AIR_DEFENSE_SILVER = 75, -- The air defense required for the airplanes to get the Castles in the Air Silver Medal
	CASTLES_IN_THE_AIR_MEDAL_AIR_DEFENSE_GOLD = 150, -- The air defense required for the airplanes to get the Castles in the Air Gold Medal
},
