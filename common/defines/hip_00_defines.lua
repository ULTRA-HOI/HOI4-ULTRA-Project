...
NAir = {
	...
	NAVAL_STRIKE_DAMAGE_TO_STR = 4, --was 1.0 --Balancing value to convert damage ( naval_strike_attack * hits ) to Strength reduction.
	...
	NAVAL_COMBAT_EXTERNAL_PLANES_JOIN_RATIO = 0.05, --was 0.05 --Max planes that can join a combat comparing to the total strength of the ships
	NAVAL_COMBAT_EXTERNAL_PLANES_JOIN_RATIO_PER_DAY = 0.2, --was 0.2 --max extra plane % that can join every day
