...
NBuildings = {
	...
	NAVALBASE_REPAIR_MULT = -0.013, --has to be negative as it scales with dockyard output. As long as dockyard output is set to -300% base for MIOs this has to stay negative to enable ship repair --was 0.05 --Each level of navalbase building repairs X strength and can repair as many ships as its level
...
NAir = {
	...
	NAVAL_STRIKE_BASE_STR_TO_PLANES_RATIO = 0.03, --was 0.03 --Max airbombers to do port strike comparing to strength
...
NIndustrialOrganisation = {
	...
	MAX_FUNDS_FROM_MANUFACTURER_PER_DAY = 5,					-- Max funds generated per manufacturer per day. Set to 0 for no Maximum.
