...
NTechnology = {
	...
	BASE_YEAR_AHEAD_PENALTY_FACTOR = 15, --was 2 --Base year ahead penalty
...
NMilitary = {
	...
	RELIABILTY_RECOVERY = 0.09,                     -- factor affecting how much equipment is returned "from the dead"
...
NAir = {
	...
	DISRUPTION_AGILITY_FACTOR = 0.125, --was 0.0
...
NNavy = {
	...
	AMPHIBIOUS_LANDING_PENALTY = -0.5, --was -0.7 --amphibious landing penalty
