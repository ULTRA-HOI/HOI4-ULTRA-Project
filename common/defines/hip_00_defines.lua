...
NGame = {
	...
	GAME_SPEED_SECONDS = { 1.0, 0.5, 0.25, 0.1, 0.0 }, -- game speeds for each level. Must be 5 entries with last one 0 for unbound
...
NCountry = {
	...
	AIR_SUPPLY_CONVERSION_SCALE = 0.015, --was 0.01 --Conversion scale for planes to air supply
	...
	SPECIAL_FORCES_CAP_BASE = 0.03, --was 0.05 --Max ammount of special forces battalions is total number of non-special forces battalions multiplied by this and modified by a country modifier
	SPECIAL_FORCES_CAP_MIN = 18, --was 24 --You can have a minimum of this many special forces battalions, regardless of the number of non-special forces battalions you have, this can also be modified by a country modifier
...
NResistance = {
	...
	RESISTANCE_TARGET_BASE = 50, --was 35.0 --base resistance target percentage
	...
	SUPPRESSION_NEEDED_BY_RESISTANCE_POINT = 0.5, --was 0.75 --Number of suppression point we need for each 1% of resistance
...
NProduction = {
	...
	MIN_POSSIBLE_TRAINING_MANPOWER = 50000, --was 100000 --How many deployment lines minimum can be training
	MIN_FIELD_TO_TRAINING_MANPOWER_RATIO = 0.50, --was 0.75 --Ratio which % of army in field can be trained
...
NTechnology = {
	...
	BASE_YEAR_AHEAD_PENALTY_FACTOR = 10, --was 2 --Base year ahead penalty
...
NBuildings = {
	...
	NAVALBASE_REPAIR_MULT = 0.04, --was 0.05 --Each level of navalbase building repairs X strength and can repair as many ships as its level
...
NMilitary = {
	...
	LAND_AIR_COMBAT_STR_DAMAGE_MODIFIER = 0.004, --was 0.032 --air global damage modifier
	LAND_AIR_COMBAT_ORG_DAMAGE_MODIFIER = 0.004, --was 0.032 --global damage modifier
	LAND_AIR_COMBAT_MAX_PLANES_PER_ENEMY_WIDTH = 20, --was 3 --how many CAS/TAC can enter a combat depending on enemy width there
	...
	PARACHUTE_COMPLETE_ORG = 0.4, --was 0.4 --Organisation value (in %) after unit being dropped, regardless if failed, disrupted, or successful.
	...
	AIR_SUPPORT_BASE = 1.0, --was 0.25 --CAS bonus factor for air support moddifier for land unit in combat
	...
	STRATEGIC_SPEED_INFRA_MAX = 10.0, --was 10.0 --Additional speed of strategic redeployment on max-level infrastructure
	STRATEGIC_SPEED_RAIL_BASE = 7.5, --was 15.0 --Base speed of strategic redeployment when on railways
	STRATEGIC_SPEED_RAIL_MAX = 25.0, --was 25.0 --Additional speed of strategic redeployment on max-level railways
...
NAir = {
	AIR_WING_FLIGHT_SPEED_MULT = 0.02, --was 0.02 --Global speed multiplier for airplanes (affects fe.transferring to another base)
	AIR_WING_MAX_STATS_ATTACK = 400, --was 100 --Max stats
	AIR_WING_MAX_STATS_DEFENCE = 400, --was 100
	AIR_WING_MAX_STATS_AGILITY = 150, --was 100
	AIR_WING_MAX_STATS_SPEED = 1500, --was 800
	...
	BIGGEST_SPEED_FACTOR_DIFF = 2.5, --was 3.5 --biggest factor difference in speed for doing damage (caps to this)
	...
	COMBAT_BETTER_AGILITY_DAMAGE_REDUCTION = 0, --was 0.30 --How much the better agility (than opponent's) can reduce their damage to us.
	COMBAT_BETTER_SPEED_DAMAGE_INCREASE = 1, --was 0.60 --How much the better Speed (than opponent's) can reduce increase our damage to them.
	...
	PORT_STRIKES_DELAY_MULTIPLIER = 4, --was 2 --multplies HOURS_DELAY_AFTER_EACH_COMBAT if port strikes
	...
	ACCIDENT_CHANCE_BALANCE_MULT = 1, --was 1 --Multiplier for balancing how often the air accident really happens. The higher mult, the more often.
	...
	AIR_NAVAL_KAMIKAZE_DAMAGE_MULT = 10.0, --was 20.0 --Balancing value to increase usual damage to Strength for Kamikaze
	...
	NAVAL_STRIKE_DETECTION_BALANCE_FACTOR = 0.25, --was 0.5 --Value used to scale the surface_visibility stats to balance the gameplay, so 100% detection chance still won't spam the strikes.
	...
	ANTI_AIR_PLANE_DAMAGE_FACTOR = 0.4, --was 0.8 --Anti Air Gun Damage factor
	ANTI_AIR_PLANE_DAMAGE_CHANCE = 0.1, --was 0.1 --Anti Air Gun hit chance
	...
	NAVAL_STRIKE_BASE_STR_TO_PLANES_RATIO = 0.01, --was 0.03 --Max airbombers to do port strike comparing to strength
	NAVAL_COMBAT_EXTERNAL_PLANES_JOIN_RATIO = 10, --was 0.05 --Max planes that can join a combat comparing to the total strength of the ships
	NAVAL_COMBAT_EXTERNAL_PLANES_JOIN_RATIO_PER_DAY = 10, --was 0.2 --max extra plane % that can join every day
	...
	AIR_WING_XP_TRAINING_MISSION_GAIN_DAILY = 4.0, --was 7.0 --Daily gain when running training exercise mission
	AIR_WING_XP_AIR_VS_AIR_COMBAT_GAIN = 4.0, --was 0.8 --Wings in combat gain extra XP
	...
	ESCORT_FACTOR = 2.0, --was 2.0
	ESCORT_SPEED_FACTOR = 0.0, --was 1.0
	ESCORT_AGILITY_FACTOR = 0.0, --was 1.0
	ESCORT_ATTACK_FACTOR = 1.0, --was 1.0
	DISRUPTION_DEFENCE_DEFENCE_FACTOR = 1.0, --was 0.5
	...
	BOMBING_TARGETING_RANDOM_FACTOR = 0.40, --was 0.25 --% of picking the wrong target
	...
	MAX_QUICK_WING_SELECTION = 5, --was 3 --Max possible selection for airwing quick deploy
...
NAI = {
	...
	RESEARCH_NEW_WEIGHT_FACTOR = 0.6, --was 0.3 --Impact of previously unexplored tech weights. Higher means more random exploration.
...
NOperatives = {
	...
	MAX_OPERATIVE_SLOT_FROM_AGENCY_UPGRADES = 4, --was 1 --max operative slots gained from upgrades
	...
	AGENCY_DEFENSE_EFFECT_ON_HOSTILE_ACTION_COST = 0.05, --was 0.2 --Defense factor that is responsible for multiplying the cost hostile actions against our country by its level and this value
...
NSupply = {
	...
	CAPITAL_SUPPLY_BASE = 0.0, --was 5.0 --base supply for capital
	CAPITAL_SUPPLY_CIVILIAN_FACTORIES = 0.075, --was 0.3 --supply from one civilian factory
	CAPITAL_SUPPLY_MILITARY_FACTORIES = 0.15, --was 0.6 --supply from one military factory
	CAPITAL_SUPPLY_DOCKYARDS = 0.1, --was 0.4 --supply from one naval factory
	...
	CAPITAL_INITIAL_SUPPLY_FLOW = 3.3, --was 5.0 --starting supply from
	CAPITAL_STARTING_PENALTY_PER_PROVINCE = 0.50, --was 0.5 --starting penalty that will be added as supply moves away from its origin (modified by stuff like terrain)
	CAPITAL_ADDED_PENALTY_PER_PROVINCE = 0.66, --was 1.2 --added penalty as we move away from origin

	-- defines that are used for supply reach for built nodes
	NODE_INITIAL_SUPPLY_FLOW = 2.0, --was 2.8
	NODE_STARTING_PENALTY_PER_PROVINCE = 0.50, --was 0.50
	NODE_ADDED_PENALTY_PER_PROVINCE = 0.33, --was 0.70

	-- defines that are used for supply reach for dockyards
	NAVAL_BASE_INITIAL_SUPPLY_FLOW = 2.5, --was 3.3
	NAVAL_BASE_STARTING_PENALTY_PER_PROVINCE = 0.50, --was 0.84
	NAVAL_BASE_ADDED_PENALTY_PER_PROVINCE = 0.50, --was 1.1

	-- Node Flow (i.e. province caps) increase by this amount per railway level of the node's bottleneck
	NODE_FLOW_BONUS_PER_RAIL_LEVEL = 0.1, --was 0.34
	...
	SUPPLY_FLOW_PENALTY_CROSSING_RIVERS = 0.10, --was 0.20 --crossing rivers introduces additional penalty

	 -- node flow terrain falloff is scaled by logistics curve based on distance(d) (scalar / (1+e^(-k(d-midpoint))))
	SUPPLY_FLOW_DIST_LOGISTICS_FALLOFF_K = 1.3, --was 1.3 --How steep the curve is
	...
	RAILWAY_FLOW_PER_LEVEL = 12.5, --was 5.0 --how much additional flow a railway level gives
	RAILWAY_FLOW_PENALTY_PER_DAMAGED = 7.5, --was 5.0 --penalty to flow per damaged railway
	...
	NAVAL_FLOW_PER_LEVEL = 1.5, --was 3.0 --max output/input of a naval node is limited by previous base value + this define per its level
	...
	INFRA_TO_SUPPLY = 0.00, --was 0.3 --each level of infra gives this many supply
	...
	SUPPLY_FROM_DAMAGED_INFRA = 0.0, --was 0.15 --damaged infrastructure counts as this in supply calcs
	...
	SUPPLY_FLOW_REDUCTION_THRESHOLD = 0.02, --was 0.1 --if supply flow is lower than this, it is not applied
	...
	DAYS_TO_START_GIVING_SUPPLY_AFTER_MOVING_SUPPLY_CAPITAL = 1, --was 7 --the country will start gaining supply after this many days moving its capital
	...
	SUPPLY_PATH_MAX_DISTANCE = 21, --was 15 --max time it can take
	...
	ALERT_VERY_LOW_SUPPLY_LEVEL = 0.66, --was 0.2 --At which point we show up the low and very low supply level alert. Value is in % of supplies supported vs required.
	ALERT_LOW_SUPPLY_LEVEL = 0.99, --was 0.5
	...
	AVAILABLE_MANPOWER_STATE_SUPPLY = 0.0, --was 0.18 --Factor for state supply from max manpower (population)
...
NAITheatre = {
	...
	AI_THEATRE_SUPPLY_CRISIS_LIMIT = 0.2, --was 0.1 --If a unit is standing in an area with this supply ratio it will try to escape
