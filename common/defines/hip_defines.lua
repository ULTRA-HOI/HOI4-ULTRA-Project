...
NDefines.NTechnology.MAX_SUBTECHS = 12						-- Max number of sub technologies a technology can have.
...
NDefines.NMilitary.OUT_OF_SUPPLY_ATTRITION = 0.05                -- max attrition when out of supply
...
NDefines.NAir.COMBAT_DAMAGE_SCALE_CARRIER = 16 --6                    -- same as above but used inside naval combat for carrier battles
