...
NDefines.NProduction.BASE_FACTORY_SPEED_MIL = 1.1 --1 --8				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
...
NDefines.NMilitary.ATTRITION_EQUIPMENT_LOSS_CHANCE = 0.009 --0.05
NDefines.NMilitary.ATTRITION_EQUIPMENT_PER_TYPE_LOSS_CHANCE = 0.24 -- Chance for loosing equipment when suffer attrition. Scaled up the stronger attrition is. Then scaled down by equipment reliability.
...
NDefines.NSupply.RAILWAY_CONVERSION_COOLDOWN = 0 --10 -- railways will be put on cooldown when they are captured by enemy and will not be usable during the cooldown -- ULtra desactivated because cannot be set separatly depending on invaded countries
NDefines.NSupply.RAILWAY_CONVERSION_COOLDOWN_CORE = 0 --5 -- Recapturing railways that have been "converted" by the ennemy does not change if core or not....
