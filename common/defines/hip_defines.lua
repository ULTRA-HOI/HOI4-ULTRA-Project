...
NDefines.NSupply.CAPITAL_ADDED_PENALTY_PER_PROVINCE = 0.1 -- 1.2 added penalty as we move away from origin
NDefines.NSupply.NODE_INITIAL_SUPPLY_FLOW = 1.5    -- 2.8
NDefines.NSupply.NODE_STARTING_PENALTY_PER_PROVINCE = 0.33 -- 0.50
NDefines.NSupply.NODE_ADDED_PENALTY_PER_PROVINCE = 0.1 --0.70 -- removed this, as don't want an exponentially increasing curve
...
NDefines.NSupply.NAVAL_BASE_ADDED_PENALTY_PER_PROVINCE = 0.1 --  1.1
