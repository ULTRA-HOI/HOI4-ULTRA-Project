...
NDefines.NResistance.COMPLIANCE_GROWTH_BASE = 0.01 -- 0.075 -- base compliance grow
NDefines.NResistance.COMPLIANCE_DECAY_AT_MAX_COMPLIANCE = -0.011 -- -0.083 -- as compliance increases, it gets a decay rate depending on its value. compliance should stabilize at some value until its growth chWanges
NDefines.NResistance.COMPLIANCE_DECAY_PER_EXILE_LEGITIMACY = -0.003 -- 0.015 -- higher legitimacy will give higher decay to compliance
-- espionage stuff 
...
NDefines.NSupply.RAILWAY_BASE_FLOW = 0.1 --10.0 		-- how much base flow railway gives when a node connected to its capital/a naval node by a railway
...
NDefines.NSupply.CAPITAL_STARTING_PENALTY_PER_PROVINCE = 0.33 -- 0.50 starting penalty that will be added as supply moves away from its origin (modified by stuff like terrain)
NDefines.NSupply.CAPITAL_ADDED_PENALTY_PER_PROVINCE = 0.05 -- 1.2 added penalty as we move away from origin
NDefines.NSupply.NODE_INITIAL_SUPPLY_FLOW = 1.5    -- 2.8
NDefines.NSupply.NODE_STARTING_PENALTY_PER_PROVINCE = 0.33 -- 0.50
NDefines.NSupply.NODE_ADDED_PENALTY_PER_PROVINCE = 0.05 --0.70 -- removed this, as don't want an exponentially increasing curve
NDefines.NSupply.NAVAL_BASE_INITIAL_SUPPLY_FLOW = 1.5 --  3.3 
NDefines.NSupply.NAVAL_BASE_STARTING_PENALTY_PER_PROVINCE = 0.33 --  0.84
NDefines.NSupply.NAVAL_BASE_ADDED_PENALTY_PER_PROVINCE = 0.05 --  1.1
