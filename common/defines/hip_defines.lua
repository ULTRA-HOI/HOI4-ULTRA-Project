...
NDefines.NSupply.RAILWAY_CONVERSION_COOLDOWN = 10 --10 -- railways will be put on cooldown when they are captured by enemy and will not be usable during the cooldown
NDefines.NSupply.RAILWAY_CONVERSION_COOLDOWN_CORE = 10 --5 -- Recapturing railways that have been "converted" by the ennemy does not change if core or not....
...
NDefines.NSupply.CAPITAL_INITIAL_SUPPLY_FLOW = 3.0 -- 5.0 starting supply from
...
NDefines.NSupply.CAPITAL_ADDED_PENALTY_PER_PROVINCE = 0.25 -- 1.2 -- added penalty as we move away from origin
NDefines.NSupply.NODE_INITIAL_SUPPLY_FLOW = 3.0    -- 2.8
NDefines.NSupply.NODE_STARTING_PENALTY_PER_PROVINCE = 0.25 -- 0.50
NDefines.NSupply.NODE_ADDED_PENALTY_PER_PROVINCE = 0.25 --0.70 -- added penalty as we move away from origin
NDefines.NSupply.NAVAL_BASE_INITIAL_SUPPLY_FLOW = 3.0 --  3.3 
NDefines.NSupply.NAVAL_BASE_STARTING_PENALTY_PER_PROVINCE = 0.25 --  0.84 -- added penalty as we move away from origin
NDefines.NSupply.NAVAL_BASE_ADDED_PENALTY_PER_PROVINCE = 0.25 --  1.1
...
NDefines.NAir.AIR_SUPPLY_CONVERSION_SCALE = 0.001	--0.05				-- Conversion scale for planes to air supply
...
NDefines.NAI.LAND_COMBAT_AIR_SUPERIORITY_IMPORTANCE = 0.2                         -- [0.20] -- Strategic importance of air superiority ( amount of enemy planes in area )
...
NDefines.NAI.LAND_COMBAT_FIGHTERS_PER_PLANE = 1.5                                    -- [1.1]  -- Amount of air superiority planes requested per enemy plane
