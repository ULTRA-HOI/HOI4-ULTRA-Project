...
NDefines.NCountry.VP_TO_SUPPLY_BONUS_CONVERSION = 0.25 --0.25 -- 0.1		 -- Bonus to supply local supplies from Victory Points, multiplied by this aspect and rounded to closest integer
...
NDefines.NCountry.SUPPLY_BONUS_FROM_INPUT = 0.35 -- 0.5					-- % of supply bonus from input area.
...
NDefines.NAI.PLAN_ATTACK_MIN_STRENGTH_FACTOR_MED = 0.4
