...
NDefines.NSupply.RAILWAY_CONVERSION_COOLDOWN = 2 --10 -- railways will be put on cooldown when they are captured by enemy and will not be usable during the cooldown -- ULtra desactivated because cannot be set separatly depending on invaded countries
NDefines.NSupply.RAILWAY_CONVERSION_COOLDOWN_CORE = 2 --5 -- Recapturing railways that have been "converted" by the ennemy does not change if core or not....
NDefines.NSupply.RAILWAY_CONVERSION_COOLDOWN_CIVILWAR = 2
