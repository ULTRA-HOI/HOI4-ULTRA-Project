...
NDefines.NNavy.ANTI_AIR_ATTACK_TO_AMOUNT = 0.005 --was 0.01 						-- Balancing value to convert equipment stat anti_air_attack to the random % value of airplanes being hit. Lower this value so that plane lost are less
...
NDefines.NNavy.HIGHER_SHIP_RATIO_POSITIONING_PENALTY_FACTOR = 0.75 --0.25 if one side has more ships than the other, that side will get this penalty for each +100% ship ratio it has
...
NDefines.NNavy.MAX_POSITIONING_PENALTY_FOR_NEWLY_JOINED_SHIPS = 0.75 --0.25 -- the accumulated penalty from new ships will be clamped to this value
NDefines.NNavy.DAMAGE_PENALTY_ON_MINIMUM_POSITIONING = 0.90 --0.5 damage penalty at 0% positioning
...
NDefines.NNavy.SUBMARINE_REVEAL_BASE_CHANCE = 9
