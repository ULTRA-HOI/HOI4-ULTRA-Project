...
NDefines.NAI.NAVAL_DOCKYARDS_SHIP_FACTOR = 12 --1.5 --The extent to which number of dockyards play into amount of sips a nation wants
NDefines.NAI.DOCKYARDS_PER_NAVAL_DESIRE_EFFECT = 10 -- -20 --Effects how much AI wants to build dockyards based on how navally focused they are in general. Recommended range -100.0 to 100.0.
NDefines.NAI.NEEDED_NAVAL_FACTORIES_EXPENSIVE_SHIP_BONUS = 36 --12 --Amount of naval yards you need to get a bonus to building really expensive ships
